...
import com.kiba.framework.utils.Base64Utils;
import com.kiba.framework.utils.StringUtils;
...
public class BaseSPUtil {
    ...
    public boolean putObject(String key, Object value) {
        return mSP.edit().putString(key, JsonUtils.Serialize_Gson(value)).commit();
    }
    ...
    public boolean putEncodeObject(String key, Object value) {
        String base64Obj = Base64Utils.encode(JsonUtils.Serialize_Gson(value), "UTF-8");
    ...
    public <T> T getEncodeObject(String key, Type type) {
        ...
        return JsonUtils.Serialize_Gson(json, type);
    }
    ...
    public <T> T getObject(String key, Type type) {
        return JsonUtils.Serialize_Gson(getString(key, ""), type);
    }
