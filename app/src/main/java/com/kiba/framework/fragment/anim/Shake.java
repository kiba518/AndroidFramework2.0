package com.kiba.framework.fragment.anim;
...
public class Shake {
    ...
    public static void tada(View view, float shakeFactor) {
        ...
        PropertyValuesHolder pvhRotate = PropertyValuesHolder.ofKeyframe(View.ROTATION,
                ...
                Keyframe.ofFloat(.1f, 1f * shakeFactor),
                Keyframe.ofFloat(.2f, -1f * shakeFactor),
    ...
    public static void nope(View view) {
        int delta = view.getResources().getDimensionPixelOffset(com.chad.library.R.dimen.dp_4);
